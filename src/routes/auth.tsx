...
// La matrícula se convierte en un correo sintético para el backend de auth.
// Esto permite usar la matrícula como identificador único sin exponer un correo real.
...
function isValidMatricula(m: string) {
  // Permite letras y números, 4-15 caracteres. Ajusta según el formato real.
